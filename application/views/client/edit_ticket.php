        ...
        <div class="page-content--bgf7">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                       <li class="list-inline-item active">
                                        ...
                                        <li class="list-inline-item">Tickets</li>
										 ...
										 <li class="list-inline-item">Update Ticket</li>
                                    </ul>
                                </div>
            ...
            <section class="welcome p-t-10">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="title-4">Update - Ticket Details
                            </h1>
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">                                           
											...
											<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-3">
                                                    ...
                                                    <input type="hidden" id="u_id" name="text-input" class="form-control" value="<?=$ticket['u_id'];?>" readonly>
...
function ticketchat()
{
   ...
   form_data.append("t_code",t_code);
	$.ajax({
                url: "<?=base_url();?>client/ticketchat",
                type: "post",
				data: form_data,
				dataType: 'json',
				contentType: false,
