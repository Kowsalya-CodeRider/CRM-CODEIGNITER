									...
									foreach($notifications as $notifications){?>
											...
											<div class="row form-group">
												...
												<div class="col col-md-2">
												   ...
												   ?>
												   <button class="btn btn-warning">Un-read</button>
												   <?php } else { ?>
												...
												<div class="col col-md-2">
                                                    <label for="text-input" class=" form-control-label">
													<a href="<?=base_url();?>client/edit_ticket/<?=$notifications['t_id'];?>" class="btn btn-info" onclick="notificationread(<?=$notifications['n_id'];?>)">View</a> 
												</label>
                                                </div>
                                            </div>
